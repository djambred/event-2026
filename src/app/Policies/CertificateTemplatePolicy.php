...
class CertificateTemplatePolicy
{
    ...
    {
        return $user->can('view_any_certificate::template');
    }
    ...
    {
        return $user->can('view_certificate::template');
    }
    ...
    {
        return $user->can('create_certificate::template');
    }
    ...
    {
        return $user->can('update_certificate::template');
    }
    ...
    {
        return $user->can('delete_certificate::template');
    }
    ...
    {
        return $user->can('delete_any_certificate::template');
    }
