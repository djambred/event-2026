...
<div class="bg-white rounded-3xl p-8 shadow-sm border border-[#e6eefd]">
    ...
    <div class="space-y-4">
        ...
        <div class="flex gap-3 items-start"><div class="w-3 h-3 rounded-full bg-[#0D5DA6] mt-1.5 shrink-0"></div><div><p class="font-['Plus_Jakarta_Sans'] font-bold text-[#141c27] text-sm">Mandatory Workshop & Preliminary Technical Meeting</p><p class="text-xs text-[#404750]">{{ $settings['workshop_date'] ?? '4 May 2026' }} (Zoom)</p></div></div>
        ...
        <div class="flex gap-3 items-start"><div class="w-3 h-3 rounded-full bg-[#8B6914] mt-1.5 shrink-0"></div><div><p class="font-['Plus_Jakarta_Sans'] font-bold text-[#141c27] text-sm">Grand Final Technical Meeting</p><p class="text-xs text-[#404750]">{{ $settings['technical_meeting_date'] ?? '6 Jun 2026' }}, {{ $settings['technical_meeting_time'] ?? '08:00 WIB' }} (Zoom)</p></div></div>
